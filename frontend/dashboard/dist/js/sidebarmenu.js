...
$('#sidebarnav >li >a.has-arrow').on('click',function(e){e.preventDefault();});if($(window).width()>768||window.Touch){$('.scroll-sidebar').animate({scrollTop:$("#sidebarnav .sidebar-item.selected").offset().top-250},500);}});